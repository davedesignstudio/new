...
3. **Bottom line** — small all-caps tagline (like `RENOVATE · REMODEL · RESTORE`)

Reference assets: `logos/brands/service-the-hills/01-primary-seal.png`, `02-alt-wordmark.png`.

Do **not** copy the saw blade for every brand unless the brand is trades/renovation. The **text structure** is the shared system.
