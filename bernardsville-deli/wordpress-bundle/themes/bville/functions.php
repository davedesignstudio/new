...
add_action('wp_enqueue_scripts', static function (): void {
    wp_enqueue_style(
        'bville-fonts',
        'https://fonts.googleapis.com/css2?family=Alegreya:ital,wght@0,700;1,700&family=Bangers&family=DM+Sans:wght@400;600;700&family=EB+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=Oleo+Script+Swash+Caps:wght@700&family=Oswald:wght@500;600;700&family=Russo+One&display=swap',
        [],
        null
    );
    wp_enqueue_style('bville-style', get_stylesheet_uri(), ['bville-fonts'], '1.4.3');
    wp_enqueue_style('bville-order-board', bville_asset('order-board.css'), ['bville-style'], '1.4.3');
    wp_enqueue_style('bville-chudo', bville_asset('chudo.css'), ['bville-order-board'], '1.4.3');
    wp_enqueue_script('bville-nav', bville_asset('nav.js'), [], '1.4.3', true);
});
