...
ITEMS = [
    ...
    # Pizza
    {"slug": "pizza-classic", "local": "pizza.jpg", "files": ["Cheese pizza.jpg", "Pizza Margherita stu spivack.jpg"], "q": ["cheese pizza mozzarella", "New York cheese pizza"]},
    {"slug": "pizza-margherita", "files": ["Pizza Margherita.jpg", "Margherita pizza.jpg"], "q": ["pizza margherita basil", "neapolitan margherita pizza"]},
    {"slug": "pizza-meat-lovers", "files": ["Pepperoni pizza.jpg", "Meat lovers pizza.jpg"], "q": ["meat lovers pizza pepperoni sausage", "pepperoni sausage pizza"]},
    {"slug": "pizza-white-pie", "files": ["White pizza.jpg", "Pizza bianca.jpg"], "q": ["white pizza ricotta mozzarella", "pizza bianca cheese"]},
    {"slug": "pizza-chicken-parm", "files": ["Chicken parmesan pizza.jpg"], "q": ["chicken parmesan pizza", "chicken cutlet pizza mozzarella"]},
    {"slug": "pizza-bbq-buffalo", "files": ["BBQ chicken pizza.jpg"], "q": ["BBQ chicken pizza", "buffalo chicken pizza"]},
    {"slug": "pizza-veggie", "files": ["Vegetarian pizza.jpg", "Veggie pizza.jpg"], "q": ["vegetarian pizza peppers mushrooms olives", "vegetable pizza"]},
    {"slug": "pizza-philly", "files": ["Cheesesteak pizza.jpg", "Steak pizza.jpg"], "q": ["philly cheesesteak pizza", "steak onion pepper pizza"]},
    {"slug": "pizza-bville-special", "files": ["Chicken pizza.jpg", "Shawarma pizza.jpg"], "q": ["chicken shawarma pizza", "chicken garlic pizza"]},
    {"slug": "pizza-thai-chili", "files": ["Thai pizza.jpg", "Sesame chicken.jpg"], "q": ["thai chicken pizza", "sesame chicken pizza"]},
    {"slug": "pizza-don-pomodoro", "files": ["Pizza al pomodoro.jpg", "Pizza with tomatoes.jpg"], "q": ["fresh tomato basil pizza", "pizza pomodoro mozzarella"]},
    {"slug": "pizza-combination", "files": ["Supreme pizza.jpg", "Combination pizza.jpg"], "q": ["supreme pizza pepperoni sausage peppers", "combination pizza"]},
    # Platters
