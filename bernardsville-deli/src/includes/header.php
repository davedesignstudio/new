...
<head>
  ...
  <link rel="stylesheet" href="<?= e(asset_url('css/style.css')) ?>?v=house9" />
  <link rel="stylesheet" href="<?= e(asset_url('css/order-board.css')) ?>?v=house9" />
  <link rel="stylesheet" href="<?= e(asset_url('css/comic.css')) ?>?v=house9" />
  <link rel="stylesheet" href="<?= e(asset_url('css/chudo.css')) ?>?v=house9" />
