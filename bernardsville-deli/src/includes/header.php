...
<head>
  ...
  <link rel="stylesheet" href="<?= e(asset_url('css/style.css')) ?>?v=house5" />
  <link rel="stylesheet" href="<?= e(asset_url('css/order-board.css')) ?>?v=house5" />
  <link rel="stylesheet" href="<?= e(asset_url('css/comic.css')) ?>?v=house5" />
  <link rel="stylesheet" href="<?= e(asset_url('css/chudo.css')) ?>?v=house5" />
