...
<head>
  ...
  <link rel="stylesheet" href="<?= e(asset_url('css/style.css')) ?>?v=house6" />
  <link rel="stylesheet" href="<?= e(asset_url('css/order-board.css')) ?>?v=house6" />
  <link rel="stylesheet" href="<?= e(asset_url('css/comic.css')) ?>?v=house6" />
  <link rel="stylesheet" href="<?= e(asset_url('css/chudo.css')) ?>?v=house6" />
