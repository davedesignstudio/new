...
<div class="order-ticket" role="navigation" aria-label="Hours, phone, and online order">
  <div class="container order-ticket-inner">
    ...
    <span class="order-ticket-cell"><?= e($site['order']['pickup']) ?> first</span>
    <span class="order-ticket-cell"><?= e($site['order']['delivery']) ?></span>
    <a class="order-ticket-cell" href="<?= e(asset_url('menu.php#kids')) ?>">Kids</a>
    <a class="order-ticket-cta" href="<?= e(asset_url($site['order']['path'])) ?>">Order pickup</a>
  </div>
</div>
