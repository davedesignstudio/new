/**
 * Pass HQ · Practice · Stamp six joints before promise
 ...
 * Practice drills ([data-practice-drill]) stamp when joints present; CTA locked until stamp.
 */
(function () {
  ...
  function updateSeal(ready) {
    ...
    seal.textContent = sealed
      ? "Practice seal · six joints stamped"
      : "Practice seal · await joint stamps";
