/**
 * Pass HR · Integrate · Fold Survey→Deepen→Crosslink→Practice into Ri stack
 ...
 * Practice drills stamp J1–J6; Integrate seal unlocks when joints + stack fold.
 */
(function () {
  ...
  function updateSeal(ready) {
    ...
    seal.textContent = sealed
      ? "Integrate seal · Ri stack folded"
      : "Integrate seal · await joint stamps";
