...
export default function PizzaBuilder() {
  ...
  const [size, setSize] = createSignal('media');
  const [crust, setCrust] = createSignal('napoletana');
      ...
      <div class="modal-overlay" onClick={close} role="presentation">
        ...
        >
          <div class="builder-header">
            ...
            <h2 id="builder-title">Componi la tua {item()?.name}</h2>
            <button type="button" class="btn-close" onClick={close} aria-label="Chiudi">
              ✕
            </button>
          </div>
