...
<main id="main">
	<section class="hero">
		<div class="hero-media" aria-hidden="true">
			<img src="<?php echo esc_url( $hero_src ); ?>" alt="<?php esc_attr_e( 'Chef tossing glowing pizza dough toward a gold-inlaid oven', 'dphilhower-studio' ); ?>" width="1536" height="1024">
		</div>
	...
	<section class="section" id="brands">
		...
		<p class="section-copy is-wide"><?php esc_html_e( 'Restaurant rooms first — pizza, coastal tables, coffee, deli, ice cream — including Bville Pizza & Grill in Bernardsville, where David was in-house graphic designer from 2018 to 2021. Construction, sleep, and Design + Build live with the rest of the brands.', 'dphilhower-studio' ); ?></p>
