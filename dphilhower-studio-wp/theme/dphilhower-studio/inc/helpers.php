...
function dps_work_card_stills() {
	return array(
		'casa-forno'         => array(
			...
			'alt'  => __( 'Casa Forno dusk trattoria window with the gold lockup on glass', 'dphilhower-studio' ),
		),
		'zarya'              => array(
			'file' => 'zarya-print-window.png',
			'alt'  => __( 'Zarya Table black hanging sign with the gold wheat seal', 'dphilhower-studio' ),
		),
