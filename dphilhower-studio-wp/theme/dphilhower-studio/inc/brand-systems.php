...
function dps_brand_label_systems() {
	return array(
		...
		'salt-cedar' => array(
			'title' => __( 'Brass on glass, the harbor in the name', 'dphilhower-studio' ),
			'mark'  => __( 'The official seal is a circular brass lockup: SC in the center, SALT & CEDAR and OYSTER BAR on the arcs, wave and cedar at the sides, navy plate, pearl ring. No clipart clam. The food is inside. Oysters · Bar · Harbor sits under the seal so the sidewalk, the list, and the bottle agree.', 'dphilhower-studio' ),
			'pack'  => array(
				array( 'label' => __( 'Vinegar', 'dphilhower-studio' ), 'value' => __( 'House oyster vinegar · 8.5 fl oz (250 mL)', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Box', 'dphilhower-studio' ), 'value' => __( 'Chilled dozen takeaway · kraft', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Keep', 'dphilhower-studio' ), 'value' => __( 'Vinegar: cool, dark. Box: keep chilled.', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Menu', 'dphilhower-studio' ), 'value' => __( 'Oysters · Chilled · Bar', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Line', 'dphilhower-studio' ), 'value' => __( 'Oysters · Bar · Harbor', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Lot', 'dphilhower-studio' ), 'value' => __( 'SC-260922', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Packed', 'dphilhower-studio' ), 'value' => __( 'Studio identity — Morris County, NJ', 'dphilhower-studio' ) ),
			),
		),
		'noche-roja' => array(
			'title' => __( 'Marigold on glass, the night in the name', 'dphilhower-studio' ),
			'mark'  => __( 'The official seal is a circular marigold lockup: NR in the center, NOCHE ROJA and CANTINA on the arcs, chili and sun at the sides, chili-red plate. No flag. The food is inside. Cantina · Fuego · Mesa sits under the seal so the sidewalk, the list, and the jar agree.', 'dphilhower-studio' ),
			'pack'  => array(
				array( 'label' => __( 'Salsa', 'dphilhower-studio' ), 'value' => __( 'House salsa roja · 12 oz (340 g)', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Box', 'dphilhower-studio' ), 'value' => __( 'Taco takeaway · kraft', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Keep', 'dphilhower-studio' ), 'value' => __( 'Salsa: refrigerate after opening.', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Menu', 'dphilhower-studio' ), 'value' => __( 'Antojitos · Tacos · Mezcal', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Line', 'dphilhower-studio' ), 'value' => __( 'Cantina · Fuego · Mesa', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Lot', 'dphilhower-studio' ), 'value' => __( 'NR-260922', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Packed', 'dphilhower-studio' ), 'value' => __( 'Studio identity — Morris County, NJ', 'dphilhower-studio' ) ),
			),
		),
		'hearth-rye' => array(
			'title' => __( 'Copper on glass, the fire in the name', 'dphilhower-studio' ),
			'mark'  => __( 'The official seal is a circular copper lockup: HR in the center, HEARTH & RYE and ROAST HOUSE on the arcs, wheat and flame at the sides, charcoal plate. No clipart steak. The food is inside. Roast · Rye · Fire sits under the seal so the sidewalk, the list, and the jar agree.', 'dphilhower-studio' ),
			'pack'  => array(
				array( 'label' => __( 'Mustard', 'dphilhower-studio' ), 'value' => __( 'House mustard · 8 oz (227 g)', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Box', 'dphilhower-studio' ), 'value' => __( 'Roast takeaway · kraft', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Keep', 'dphilhower-studio' ), 'value' => __( 'Mustard: refrigerate after opening.', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Menu', 'dphilhower-studio' ), 'value' => __( 'Roasts · Rye · Sides', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Line', 'dphilhower-studio' ), 'value' => __( 'Roast · Rye · Fire', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Lot', 'dphilhower-studio' ), 'value' => __( 'HR-260922', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Packed', 'dphilhower-studio' ), 'value' => __( 'Studio identity — Morris County, NJ', 'dphilhower-studio' ) ),
			),
		),
		'black-olive' => array(
			'title' => __( 'Olive on glass, the sea in the name', 'dphilhower-studio' ),
			'mark'  => __( 'The official seal is a circular cream lockup: BO in the center, BLACK OLIVE and MEZE on the arcs, olive branch at the sides, olive-green plate, Aegean accents. No flag. The food is inside. Meze · Olive · Sea sits under the seal so the sidewalk, the list, and the bottle agree.', 'dphilhower-studio' ),
			'pack'  => array(
				array( 'label' => __( 'Oil', 'dphilhower-studio' ), 'value' => __( 'Extra virgin · cold pressed · 16.9 fl oz (500 mL)', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Box', 'dphilhower-studio' ), 'value' => __( 'Meze takeaway · kraft', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Keep', 'dphilhower-studio' ), 'value' => __( 'Oil: cool, dark. Box: keep refrigerated.', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Menu', 'dphilhower-studio' ), 'value' => __( 'Meze · Olives · Fish', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Line', 'dphilhower-studio' ), 'value' => __( 'Meze · Olive · Sea', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Lot', 'dphilhower-studio' ), 'value' => __( 'BO-260922', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Packed', 'dphilhower-studio' ), 'value' => __( 'Studio identity — Morris County, NJ', 'dphilhower-studio' ) ),
			),
		),
		'mizu' => array(
			'title' => __( 'Indigo on glass, the steam in the name', 'dphilhower-studio' ),
			'mark'  => __( 'The official seal is a circular indigo lockup: MIZU in the center, RAMEN and STEAM · NIGHT on the arcs, a wave motif, thin vermillion ring. No cartoon noodles. The food is inside. Ramen · Steam · Night sits under the seal so the sidewalk, the list, and the bottle agree.', 'dphilhower-studio' ),
			'pack'  => array(
				array( 'label' => __( 'Oil', 'dphilhower-studio' ), 'value' => __( 'House chili oil · 6.8 fl oz (200 mL)', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Box', 'dphilhower-studio' ), 'value' => __( 'Ramen takeaway · kraft', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Keep', 'dphilhower-studio' ), 'value' => __( 'Oil: cool, dark. Box: keep hot / eat soon.', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Menu', 'dphilhower-studio' ), 'value' => __( 'Ramen · Small plates · Tea', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Line', 'dphilhower-studio' ), 'value' => __( 'Ramen · Steam · Night', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Lot', 'dphilhower-studio' ), 'value' => __( 'MZ-260922', 'dphilhower-studio' ) ),
				array( 'label' => __( 'Packed', 'dphilhower-studio' ), 'value' => __( 'Studio identity — Morris County, NJ', 'dphilhower-studio' ) ),
			),
		),
