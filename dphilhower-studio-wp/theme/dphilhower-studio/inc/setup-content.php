...
function dps_seed_demo_content( $force = false ) {
	...
	$images    = array(
		...
		'casa-forno-hero.png'    => dps_sideload_theme_image( 'casa-forno-hero.png', 'Casa Forno' ),
		'zarya-hero.png'         => dps_sideload_theme_image( 'zarya-hero.png', 'Zarya Table' ),
	);
	...
	$projects = array(
		array(
			...
			'excerpt'  => 'Italian trattoria · window + menu',
			'subtitle' => 'Italian trattoria · window + menu',
			'client'   => 'Studio study — Italian fire table',
			'services' => 'Identity · signage · menu',
			'year'     => '2026',
			'location' => 'Studio study',
			'content'  => '<p>An Italian trattoria lockup using the studio’s carved-plaster system: serif CASA, script Forno, terracotta arch, olive sprig, and <span class="tagline-inline">CUCINA · FIRE · TABLE</span> in small caps. The arch is the oven. The olive is the kitchen.</p><p>Same construction as Cala and True Olive: one lockup, then the street, then the sheet the guest holds. Window gold on dusk stucco. Menu in terracotta and olive on cream. No food photographs on the paper — the kitchen is twenty feet away. Studio study, not a live job.</p>',
		),
		array(
			'slug'     => 'zarya',
			'title'    => 'Zarya Table',
			'image'    => 'zarya-hero.png',
			'excerpt'  => 'Russian hall · seal + dinner paper',
			'subtitle' => 'Russian hall · seal + dinner paper',
			'client'   => 'Studio study — Moscow fire hall',
			'services' => 'Identity · signage · menu',
			'year'     => '2026',
			'location' => 'Studio study',
			'content'  => '<p>A Russian hall identity using the studio’s gold-seal system: serif ZARYA, script Table, wheat wreath, onion-dome mark, and <span class="tagline-inline">MOSCOW · FIRE · HALL</span> on the arc. The wreath is wheat. The dome is the hall. Black is only the disc so gold reads from the curb.</p><p>Same hospitality order as True Olive: lockup, street, sheet. Hanging black sign, gold foil, birch and snow outside, warm hall inside. Menu in gold and oxblood on cream. No food photographs. No invented prices. Studio study, not a live reservation book.</p>',
		),
		array(
	...
	update_option( 'dps_images_version', 'brands-print-29-casa-zarya' );
	return true;
}
