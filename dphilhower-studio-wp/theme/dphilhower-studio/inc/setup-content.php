...
function dps_seed_demo_content( $force = false ) {
	...
	$projects = array(
		...
		array(
			...
			'year'     => '2025',
			'location' => 'Northern New Jersey',
			'content'  => '<p>Same seal as Service The Hills: official bronze saw blade, double ring, top arc. PHILHOWER in caps serif. O’Krogly in script. DESIGN + BUILD on the bottom arc. Same metal, same hierarchy — different names.</p><p>One lockup. Polo, van, yard, card, fridge. Black field so gold reads.</p>',
		),
		array(
			'slug'     => 'cafe-robust',
			'title'    => 'Cafe Robust',
	...
	update_option( 'dps_images_version', 'brands-print-17' );
	return true;
}
