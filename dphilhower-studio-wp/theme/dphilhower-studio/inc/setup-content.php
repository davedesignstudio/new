...
function dps_seed_demo_content( $force = false ) {
	...
	$projects = array(
		...
		array(
			...
			'title'    => 'Ember Pie Co.',
			'image'    => 'ember-kit.png',
			'excerpt'  => 'Full process · full branding',
			'subtitle' => 'Full process · full branding',
			'client'   => 'Morris County pie shop',
			'services' => 'Identity · process · menu · print · packaging · website',
			'year'     => '2026',
		...
		array(
			...
			'excerpt'  => 'Full process · in-house 2018–2021',
			'subtitle' => 'Full process · in-house 2018–2021',
			'client'   => 'Bville Pizza & Grill',
			'services' => 'In-house graphic designer · full process · branding · menus · websites',
			'year'     => '2018–2021',
		...
		array(
			...
			'excerpt'  => 'Full process · trattoria system',
			'subtitle' => 'Full process · trattoria system',
		...
		array(
			'slug'     => 'salt-cedar',
			'title'    => 'Salt & Cedar',
			'image'    => 'salt-cedar-hero.png',
			'excerpt'  => 'Full process · oyster bar system',
			'subtitle' => 'Full process · oyster bar system',
			'client'   => 'Studio identity — Coastal oyster bar',
			'services' => 'Identity · process · menu · window · packaging · website',
			'year'     => '2026',
			'location' => 'Morris County, NJ',
			'content'  => '<p>Salt & Cedar is a studio oyster-bar system written for a harbor room that wants brass on glass, not a clipart clam. Sit at the bar, write Oysters · Bar · Harbor, draw the SC seal, then put that badge on the dusk window, the cream list, the vinegar bottle, and the phone.</p><p>Navy is the water. Cedar is the board. Pearl is the stock. Brass is the physical sign. No food photography on the menu — the kitchen is twenty feet away. This is a studio identity, not a live account.</p>',
		),
		array(
			'slug'     => 'noche-roja',
			'title'    => 'Noche Roja',
			'image'    => 'noche-roja-hero.png',
			'excerpt'  => 'Full process · cantina system',
			'subtitle' => 'Full process · cantina system',
			'client'   => 'Studio identity — Mexican cantina',
			'services' => 'Identity · process · menu · window · packaging · website',
			'year'     => '2026',
			'location' => 'Morris County, NJ',
			'content'  => '<p>Noche Roja is a studio cantina system written for a room that wants fire on the table, not a flag on the wall. Sit at the mesa, write Cantina · Fuego · Mesa, draw the NR seal, then put that badge on glass, the cream list, the salsa jar, and the phone.</p><p>Chili is the heat. Adobe is the wall. Ink is the night. Marigold is the physical stamp. No food photography on the menu. This is a studio identity, not a live account.</p>',
		),
		array(
			'slug'     => 'hearth-rye',
			'title'    => 'Hearth & Rye',
			'image'    => 'hearth-rye-hero.png',
			'excerpt'  => 'Full process · roast-house system',
			'subtitle' => 'Full process · roast-house system',
			'client'   => 'Studio identity — American roast house',
			'services' => 'Identity · process · menu · window · packaging · website',
			'year'     => '2026',
			'location' => 'Morris County, NJ',
			'content'  => '<p>Hearth & Rye is a studio roast-house system written for a room with a fire and a loaf on the board. Sit at the two-top, write Roast · Rye · Fire, draw the HR seal, then put that badge on glass, the cream list, the mustard jar, and the phone.</p><p>Charcoal is the room. Rye is the loaf. Cream is the stock. Copper is the physical stamp. No food photography on the menu. This is a studio identity, not a live account.</p>',
		),
		array(
			'slug'     => 'black-olive',
			'title'    => 'Black Olive',
			'image'    => 'black-olive-hero.png',
			'excerpt'  => 'Full process · meze system',
			'subtitle' => 'Full process · meze system',
			'client'   => 'Studio identity — Greek meze room',
			'services' => 'Identity · process · menu · window · packaging · website',
			'year'     => '2026',
			'location' => 'Morris County, NJ',
			'content'  => '<p>Black Olive is a studio meze system written for a whitewashed room that wants an olive branch on glass, not a flag. Sit at the two-top, write Meze · Olive · Sea, draw the BO seal, then put that badge on the dusk window, the cream list, the oil bottle, and the phone.</p><p>Olive is the grove. Black is the night. Whitewash is the wall. Aegean is the water. No food photography on the menu. This is a studio identity, not a live account.</p>',
		),
		array(
			'slug'     => 'mizu',
			'title'    => 'Mizu',
			'image'    => 'mizu-hero.png',
			'excerpt'  => 'Full process · ramen system',
			'subtitle' => 'Full process · ramen system',
			'client'   => 'Studio identity — Japanese ramen house',
			'services' => 'Identity · process · menu · window · packaging · website',
			'year'     => '2026',
			'location' => 'Morris County, NJ',
			'content'  => '<p>Mizu is a studio ramen system written for steam on a wet sidewalk. Sit at the counter, write Ramen · Steam · Night, draw the indigo seal, then put that badge on glass, the cream list, the chili-oil bottle, and the phone.</p><p>Indigo is the night. Steam is the stock. Charcoal is the counter. Vermillion is the only loud accent. No food photography on the menu. This is a studio identity, not a live account.</p>',
		),
		array(
			'slug'     => 'cafe-robust',
			'title'    => 'Cafe Robust',
			...
			'year'     => '2026',
			'location' => 'Morris County, NJ',
			'content'  => '<p>A chalkboard that tries to look handmade usually looks cheap. This one is drawn as a sign: gold filigree, a cup from above, and a list you can read from the door.</p><p>The official seal is the crema ring: gold CR, silver CAFE / ROBUST, stars, and a foam border. That badge sits centered on the cups. The bag is a finished retail pack — House Blend, dark roast, whole bean, net weight, origin, tasting notes, roast date, Nutrition Facts, ingredients, brew, lot, and barcode. The board and window keep the cup-from-above so the shop still reads from the sidewalk.</p>',
		),
		array(
			'slug'     => 'expresso',
			'title'    => 'EXPresso',
