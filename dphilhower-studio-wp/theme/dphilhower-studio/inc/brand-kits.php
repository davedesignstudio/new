...
function dps_brand_kits() {
	return array(
		...
		'casa-forno'               => array(
			'label'  => __( 'Print system', 'dphilhower-studio' ),
			'title'  => __( 'How Casa Forno leaves the table', 'dphilhower-studio' ),
			'intro'  => __( 'Carved plaster lockup, then the dusk window, then cream dinner paper. Same construction as Cala and True Olive — mark, street, sheet.', 'dphilhower-studio' ),
			'pieces' => array(
				array(
					'file'    => 'casa-forno-hero.png',
					'alt'     => __( 'Casa Forno carved plaster lockup: terracotta arch, olive sprig, CASA serif and gold script Forno', 'dphilhower-studio' ),
					'heading' => __( 'Lockup', 'dphilhower-studio' ),
					'story'   => __( 'CASA in carved caps. Forno in gold script. The arch is the oven. The olive is the kitchen.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'casa-forno-print-window.png',
					'alt'     => __( 'Casa Forno gold window mark on a dusk trattoria storefront', 'dphilhower-studio' ),
					'heading' => __( 'Window', 'dphilhower-studio' ),
					'story'   => __( 'Gold on dusk stucco. Olive pot, warm interior, the lockup on glass so the sidewalk knows the fire table.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'casa-forno-print-menu.png',
					'alt'     => __( 'Casa Forno cream dinner menu with terracotta border and Italian courses', 'dphilhower-studio' ),
					'heading' => __( 'Dinner menu', 'dphilhower-studio' ),
					'story'   => __( 'Cream stock. Terracotta and olive rules. Primi, secondi, dolci. No food photos: the kitchen is twenty feet away.', 'dphilhower-studio' ),
				),
			),
		),
		'zarya'                    => array(
			'label'  => __( 'Print system', 'dphilhower-studio' ),
			'title'  => __( 'How Zarya leaves the hall', 'dphilhower-studio' ),
			'intro'  => __( 'Gold wheat seal, hanging black sign, cream dinner paper. Same seal construction as True Olive — wreath, street, sheet.', 'dphilhower-studio' ),
			'pieces' => array(
				array(
					'file'    => 'zarya-hero.png',
					'alt'     => __( 'Zarya Table gold wheat-wreath seal with onion-dome mark on black', 'dphilhower-studio' ),
					'heading' => __( 'Lockup', 'dphilhower-studio' ),
					'story'   => __( 'ZARYA in gold caps. Table in script. Wheat wreath, onion-dome mark, MOSCOW FIRE HALL on the arc.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'zarya-print-window.png',
					'alt'     => __( 'Zarya Table black hanging sign with gold seal on a snowy brick street', 'dphilhower-studio' ),
					'heading' => __( 'Street sign', 'dphilhower-studio' ),
					'story'   => __( 'Black field, gold foil. Birch and snow outside, warm hall inside. Readable from the curb without a Kremlin postcard.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'zarya-print-menu.png',
					'alt'     => __( 'Zarya Table cream dinner menu with gold seal and Russian dishes', 'dphilhower-studio' ),
					'heading' => __( 'Dinner menu', 'dphilhower-studio' ),
					'story'   => __( 'Cream stock. Gold and oxblood rules. Borscht through honey cake. No food photos. No invented prices.', 'dphilhower-studio' ),
				),
			),
		),
