...
function dps_brand_kits() {
	return array(
		...
		'philhower-okrogly'        => array(
			...
			'intro'  => __( 'Same seal as Service The Hills: official bronze blade, double ring. Philhower and O’Krogly share one modern Times serif — same size and weight. DESIGN + BUILD on the bottom arc. Polo, van, yard, card, fridge — one lockup.', 'dphilhower-studio' ),
			'pieces' => array(
				array(
				...
				array(
					...
					'story'   => __( 'Center chest. Same Hills blade; both names in one modern Times serif.', 'dphilhower-studio' ),
				),
				array(
				...
				array(
					...
					'story'   => __( 'Black stock. Blade and uniform Times names — same lockup as the shirt.', 'dphilhower-studio' ),
				),
				array(
