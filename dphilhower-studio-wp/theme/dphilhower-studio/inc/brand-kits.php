		...
		'bville-pizza-grill'       => array(
			...
			'pieces' => array(
				...
				array(
					...
					'story'   => __( 'Swoosh punches instead of circles so every visit restates the framing arcs from the logo. Ten pies, one on the house — hospitality, not a coupon burst.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'bville-print-matches.png',
					'alt'     => __( 'Forest green Bville napkin band and gold-stamp matchbook', 'dphilhower-studio' ),
					'heading' => __( 'Napkin band and matchbook', 'dphilhower-studio' ),
					'story'   => __( 'Forest green is the ville color taken off the wordmark and wrapped around linen. Gold stamp is the outline.', 'dphilhower-studio' ),
				),
				array(
