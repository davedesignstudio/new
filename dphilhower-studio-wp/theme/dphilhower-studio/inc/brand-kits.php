		...
		'philhower-okrogly'        => array(
			...
			'pieces' => array(
				array(
					...
					'alt'     => __( 'Black polo with the official 2025 Philhower & O’Krogly embroidery on the chest', 'dphilhower-studio' ),
					'heading' => __( 'Polo', 'dphilhower-studio' ),
					'story'   => __( 'The reason the file exists. Gold thread and a blue diamond on black piqué, left chest, no redraw.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'pok-print-van.png',
					'alt'     => __( 'Matte black van with the official Philhower & O’Krogly embroidery lockup on the side', 'dphilhower-studio' ),
					'heading' => __( 'Van', 'dphilhower-studio' ),
					'story'   => __( 'The same square lockup, vehicle scale. Matte black, not hazard orange.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'pok-print-yard.png',
					'alt'     => __( 'Black yard sign with the official Philhower & O’Krogly embroidery lockup', 'dphilhower-studio' ),
					'heading' => __( 'Yard sign', 'dphilhower-studio' ),
					'story'   => __( 'The embroidery, lawn scale. Readable from the curb without a stock “we’re working here” banner.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'pok-print-card.png',
					'alt'     => __( 'Black business cards with the official Philhower & O’Krogly embroidery lockup', 'dphilhower-studio' ),
					'heading' => __( 'Cards', 'dphilhower-studio' ),
					'story'   => __( 'Black stock, the uploaded lockup. The 908 number is already in the mark.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'pok-print-magnet.png',
					'alt'     => __( 'Fridge magnet with the official Philhower & O’Krogly embroidery lockup', 'dphilhower-studio' ),
					'heading' => __( 'Fridge magnet', 'dphilhower-studio' ),
					'story'   => __( 'The 2am number has to live in the kitchen. Same embroidery, magnet scale.', 'dphilhower-studio' ),
				),
			),
		),
		'expresso'                 => array(
