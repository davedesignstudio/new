...
function dps_brand_kits() {
	return array(
		...
		'true-olive'               => array(
			'label'  => __( 'Print system', 'dphilhower-studio' ),
			'title'  => __( 'How True Olive leaves the table', 'dphilhower-studio' ),
			'intro'  => __( 'Seal, room, street, dinner menu, card, cups, tin. The same wreath — not a lantern substitute. Print is the restaurant at the scale a guest actually holds.', 'dphilhower-studio' ),
			'pieces' => array(
				array(
					...
					'heading' => __( 'The lockup', 'dphilhower-studio' ),
					'story'   => __( 'Bronze wreath, serif TRUE, script Olive, PRESS TABLE SHORE on the arc. This is the logo. Everything else is this, moved.', 'dphilhower-studio' ),
				),
				array(
					...
					'heading' => __( 'In the room', 'dphilhower-studio' ),
					'story'   => __( 'Golden stone, olive trees, copper, cream, harbor through the arch. The seal is small on the wall. The weather is the restaurant.', 'dphilhower-studio' ),
				),
				array(
					...
					'story'   => __( 'Black field, bronze olive, the limestone behind it. Readable from the curb without a postcard of the harbor on the board.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'true-olive-print-menu.png',
					'alt'     => __( 'Cream True Olive dinner menu with the bronze seal at the top, two columns of trays, olive names, no prices', 'dphilhower-studio' ),
					'heading' => __( 'Dinner menu', 'dphilhower-studio' ),
					'story'   => __( 'Cream stock. Centered seal. Two columns. Names in olive, rules in bronze. No food photos: the kitchen is twenty feet away. No invented prices.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'true-olive-print-stationery.png',
					'alt'     => __( 'Cream True Olive menu listing trays with a black gold-foil business card', 'dphilhower-studio' ),
					'heading' => __( 'Card', 'dphilhower-studio' ),
					'story'   => __( 'Black stock, bronze foil seal. Pocket scale of the same wreath that sits on the dinner sheet.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'true-olive-print-cups.png',
					'alt'     => __( 'True Olive black cup, cream cup, and house olive-oil carton on a limestone terrace', 'dphilhower-studio' ),
					'heading' => __( 'Cups and oil', 'dphilhower-studio' ),
					'story'   => __( 'Black cup and cream cup, same construction. The carton is house olive oil — coast harvest, not a generic coffee sleeve.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'true-olive-print-sticker.png',
					'alt'     => __( 'Die-cut bronze True Olive olive-leaf seal on a weathered olive-oil tin beside a copper tray', 'dphilhower-studio' ),
					'heading' => __( 'Oil-tin sticker', 'dphilhower-studio' ),
					'story'   => __( 'The olive is the tool. Die-cut bronze on the tin so the pantry matches the street.', 'dphilhower-studio' ),
				),
			),
		),
