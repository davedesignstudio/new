		...
		'true-olive'               => array(
			...
			'pieces' => array(
				array(
					...
					'story'   => __( 'Black field, bronze olive, the limestone behind it. Gold lantern kitsch would look like a franchise. Readable from the curb without a postcard of the harbor on the board.', 'dphilhower-studio' ),
				),
				array(
				...
				array(
					...
					'story'   => __( 'Black cup and cream cup, same construction. The carton is house olive oil — coast harvest, not a generic coffee sleeve. Bronze foil on both stocks.', 'dphilhower-studio' ),
				),
				array(
					...
					'story'   => __( 'The olive is the tool. Die-cut bronze on the tin so the pantry kit matches the street. Grit and glamour at the scale of a hand.', 'dphilhower-studio' ),
				),
			),
		),
		'ritual-cafe'              => array(
