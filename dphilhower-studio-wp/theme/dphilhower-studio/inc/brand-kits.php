...
function dps_brand_kits() {
	return array(
		...
		'philhower-okrogly'        => array(
			...
			'intro'  => __( 'Hills blade. Balanced lockup: PK overlapping the carpenter-square on a gold–burgundy field. PHILHOWER and O’Krogly in the diamond points. DESIGN + BUILD on the bottom arc. Polo, van, yard, card, fridge — one lockup.', 'dphilhower-studio' ),
			'pieces' => array(
				array(
				...
				array(
					...
					'story'   => __( 'Center chest. Big Old English PK overlapping the square on a gold–burgundy field; Times and Garamond over it.', 'dphilhower-studio' ),
				),
				array(
		...
		'salt-cedar' => array(
			'label'  => __( 'Print system', 'dphilhower-studio' ),
			'title'  => __( 'The seal, then the harbor', 'dphilhower-studio' ),
			'intro'  => __( 'Official SC badge on black. Brass vinyl on the dusk window. Cream menu. Vinegar, takeaway, cards, coasters, loyalty, poster, and matchbook carry the same navy and brass.', 'dphilhower-studio' ),
			'pieces' => array(
				array(
					'file'    => 'salt-cedar-print-seal.png',
					'alt'     => __( 'Salt & Cedar seal', 'dphilhower-studio' ),
					'heading' => __( 'Seal', 'dphilhower-studio' ),
					'story'   => __( 'The official lockup. Brass SC, navy plate, pearl ring. The food stays inside.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'salt-cedar-print-window.png',
					'alt'     => __( 'Salt & Cedar window', 'dphilhower-studio' ),
					'heading' => __( 'Window', 'dphilhower-studio' ),
					'story'   => __( 'Brass seal on glass, cream hours, hanging wordmark. The sidewalk should know the bar before the door.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'salt-cedar-print-menu.png',
					'alt'     => __( 'Salt & Cedar menu', 'dphilhower-studio' ),
					'heading' => __( 'Menu', 'dphilhower-studio' ),
					'story'   => __( 'Cream stock, navy headings, brass rules. No food photos: the shucker is twenty feet away.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'salt-cedar-print-pack.png',
					'alt'     => __( 'Salt & Cedar vinegar and box', 'dphilhower-studio' ),
					'heading' => __( 'Vinegar and box', 'dphilhower-studio' ),
					'story'   => __( 'Same seal on green glass and kraft. House vinegar 250 mL, chilled dozen, lot SC-260922.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'salt-cedar-print-cards.png',
					'alt'     => __( 'Salt & Cedar business cards', 'dphilhower-studio' ),
					'heading' => __( 'Business cards', 'dphilhower-studio' ),
					'story'   => __( 'Navy field is the water, brass SC is the window stamp in a pocket. Cream reverse sits next to the menu.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'salt-cedar-print-coasters.png',
					'alt'     => __( 'Salt & Cedar coasters', 'dphilhower-studio' ),
					'heading' => __( 'Coasters', 'dphilhower-studio' ),
					'story'   => __( 'The seal in the center so a glass still frames the mark. Pearl and navy on the table.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'salt-cedar-print-loyalty.png',
					'alt'     => __( 'Salt & Cedar loyalty card', 'dphilhower-studio' ),
					'heading' => __( 'Loyalty card', 'dphilhower-studio' ),
					'story'   => __( 'Ten visits, one dozen. Oval punches so every return restates the seal.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'salt-cedar-print-poster.png',
					'alt'     => __( 'Salt & Cedar dining-room poster', 'dphilhower-studio' ),
					'heading' => __( 'Dining-room poster', 'dphilhower-studio' ),
					'story'   => __( 'The line is the only copy besides the seal. Cream sheet, navy ink, one brass rule.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'salt-cedar-print-matches.png',
					'alt'     => __( 'Salt & Cedar napkin band and matchbook', 'dphilhower-studio' ),
					'heading' => __( 'Napkin band and matchbook', 'dphilhower-studio' ),
					'story'   => __( 'Navy band around cream linen. The matchbook is a pocket version of the poster line.', 'dphilhower-studio' ),
				),
			),
		),
		'noche-roja' => array(
			'label'  => __( 'Print system', 'dphilhower-studio' ),
			'title'  => __( 'The seal, then the cantina', 'dphilhower-studio' ),
			'intro'  => __( 'Official NR badge on black. Marigold vinyl on the dusk window. Cream menu. Salsa, takeaway, cards, coasters, loyalty, poster, and matchbook carry the same chili and marigold.', 'dphilhower-studio' ),
			'pieces' => array(
				array(
					'file'    => 'noche-roja-print-seal.png',
					'alt'     => __( 'Noche Roja seal', 'dphilhower-studio' ),
					'heading' => __( 'Seal', 'dphilhower-studio' ),
					'story'   => __( 'The official lockup. Marigold NR, chili plate. The food stays inside.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'noche-roja-print-window.png',
					'alt'     => __( 'Noche Roja window', 'dphilhower-studio' ),
					'heading' => __( 'Window', 'dphilhower-studio' ),
					'story'   => __( 'Marigold seal on glass, cream hours, hanging wordmark. The sidewalk should know the room before the door.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'noche-roja-print-menu.png',
					'alt'     => __( 'Noche Roja menu', 'dphilhower-studio' ),
					'heading' => __( 'Menu', 'dphilhower-studio' ),
					'story'   => __( 'Cream stock, chili headings, marigold rules. No food photos.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'noche-roja-print-pack.png',
					'alt'     => __( 'Noche Roja salsa and box', 'dphilhower-studio' ),
					'heading' => __( 'Salsa and box', 'dphilhower-studio' ),
					'story'   => __( 'Same seal on glass and kraft. House salsa 12 oz, taco takeaway, lot NR-260922.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'noche-roja-print-cards.png',
					'alt'     => __( 'Noche Roja business cards', 'dphilhower-studio' ),
					'heading' => __( 'Business cards', 'dphilhower-studio' ),
					'story'   => __( 'Chili field is the plate, marigold NR is the window stamp in a pocket.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'noche-roja-print-coasters.png',
					'alt'     => __( 'Noche Roja coasters', 'dphilhower-studio' ),
					'heading' => __( 'Coasters', 'dphilhower-studio' ),
					'story'   => __( 'The seal in the center so a glass still frames the mark.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'noche-roja-print-loyalty.png',
					'alt'     => __( 'Noche Roja loyalty card', 'dphilhower-studio' ),
					'heading' => __( 'Loyalty card', 'dphilhower-studio' ),
					'story'   => __( 'Ten visits, one mezcal. Oval punches so every return restates the seal.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'noche-roja-print-poster.png',
					'alt'     => __( 'Noche Roja dining-room poster', 'dphilhower-studio' ),
					'heading' => __( 'Dining-room poster', 'dphilhower-studio' ),
					'story'   => __( 'The line is the only copy besides the seal. Cream sheet, chili ink, one marigold rule.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'noche-roja-print-matches.png',
					'alt'     => __( 'Noche Roja napkin band and matchbook', 'dphilhower-studio' ),
					'heading' => __( 'Napkin band and matchbook', 'dphilhower-studio' ),
					'story'   => __( 'Chili band around cream linen. The matchbook is a pocket version of the poster line.', 'dphilhower-studio' ),
				),
			),
		),
		'hearth-rye' => array(
			'label'  => __( 'Print system', 'dphilhower-studio' ),
			'title'  => __( 'The seal, then the roast', 'dphilhower-studio' ),
			'intro'  => __( 'Official HR badge on black. Copper vinyl on the dusk window. Cream menu. Mustard, takeaway, cards, coasters, loyalty, poster, and matchbook carry the same charcoal and copper.', 'dphilhower-studio' ),
			'pieces' => array(
				array(
					'file'    => 'hearth-rye-print-seal.png',
					'alt'     => __( 'Hearth & Rye seal', 'dphilhower-studio' ),
					'heading' => __( 'Seal', 'dphilhower-studio' ),
					'story'   => __( 'The official lockup. Copper HR, charcoal plate. The food stays inside.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'hearth-rye-print-window.png',
					'alt'     => __( 'Hearth & Rye window', 'dphilhower-studio' ),
					'heading' => __( 'Window', 'dphilhower-studio' ),
					'story'   => __( 'Copper seal on glass, cream hours, hanging wordmark. The sidewalk should know the room before the door.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'hearth-rye-print-menu.png',
					'alt'     => __( 'Hearth & Rye menu', 'dphilhower-studio' ),
					'heading' => __( 'Menu', 'dphilhower-studio' ),
					'story'   => __( 'Cream stock, charcoal headings, copper rules. No food photos.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'hearth-rye-print-pack.png',
					'alt'     => __( 'Hearth & Rye mustard and box', 'dphilhower-studio' ),
					'heading' => __( 'Mustard and box', 'dphilhower-studio' ),
					'story'   => __( 'Same seal on glass and kraft. House mustard 8 oz, roast takeaway, lot HR-260922.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'hearth-rye-print-cards.png',
					'alt'     => __( 'Hearth & Rye business cards', 'dphilhower-studio' ),
					'heading' => __( 'Business cards', 'dphilhower-studio' ),
					'story'   => __( 'Charcoal field is the room, copper HR is the window stamp in a pocket.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'hearth-rye-print-coasters.png',
					'alt'     => __( 'Hearth & Rye coasters', 'dphilhower-studio' ),
					'heading' => __( 'Coasters', 'dphilhower-studio' ),
					'story'   => __( 'The seal in the center so a glass still frames the mark.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'hearth-rye-print-loyalty.png',
					'alt'     => __( 'Hearth & Rye loyalty card', 'dphilhower-studio' ),
					'heading' => __( 'Loyalty card', 'dphilhower-studio' ),
					'story'   => __( 'Ten visits, one loaf. Oval punches so every return restates the seal.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'hearth-rye-print-poster.png',
					'alt'     => __( 'Hearth & Rye dining-room poster', 'dphilhower-studio' ),
					'heading' => __( 'Dining-room poster', 'dphilhower-studio' ),
					'story'   => __( 'The line is the only copy besides the seal. Cream sheet, charcoal ink, one copper rule.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'hearth-rye-print-matches.png',
					'alt'     => __( 'Hearth & Rye napkin band and matchbook', 'dphilhower-studio' ),
					'heading' => __( 'Napkin band and matchbook', 'dphilhower-studio' ),
					'story'   => __( 'Charcoal band around cream linen. The matchbook is a pocket version of the poster line.', 'dphilhower-studio' ),
				),
			),
		),
		'black-olive' => array(
			'label'  => __( 'Print system', 'dphilhower-studio' ),
			'title'  => __( 'The seal, then the meze', 'dphilhower-studio' ),
			'intro'  => __( 'Official BO badge on black. Cream vinyl on the dusk window. Cream menu. Oil, takeaway, cards, coasters, loyalty, poster, and matchbook carry the same olive and Aegean.', 'dphilhower-studio' ),
			'pieces' => array(
				array(
					'file'    => 'black-olive-print-seal.png',
					'alt'     => __( 'Black Olive seal', 'dphilhower-studio' ),
					'heading' => __( 'Seal', 'dphilhower-studio' ),
					'story'   => __( 'The official lockup. Cream BO, olive plate. The food stays inside.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'black-olive-print-window.png',
					'alt'     => __( 'Black Olive window', 'dphilhower-studio' ),
					'heading' => __( 'Window', 'dphilhower-studio' ),
					'story'   => __( 'Seal on glass, cream hours, hanging wordmark. The sidewalk should know the room before the door.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'black-olive-print-menu.png',
					'alt'     => __( 'Black Olive menu', 'dphilhower-studio' ),
					'heading' => __( 'Menu', 'dphilhower-studio' ),
					'story'   => __( 'Cream stock, olive headings, Aegean rules. No food photos.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'black-olive-print-pack.png',
					'alt'     => __( 'Black Olive oil and box', 'dphilhower-studio' ),
					'heading' => __( 'Oil and box', 'dphilhower-studio' ),
					'story'   => __( 'Same seal on green glass and kraft. Extra virgin 500 mL, meze takeaway, lot BO-260922.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'black-olive-print-cards.png',
					'alt'     => __( 'Black Olive business cards', 'dphilhower-studio' ),
					'heading' => __( 'Business cards', 'dphilhower-studio' ),
					'story'   => __( 'Olive field is the grove, cream BO is the window stamp in a pocket.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'black-olive-print-coasters.png',
					'alt'     => __( 'Black Olive coasters', 'dphilhower-studio' ),
					'heading' => __( 'Coasters', 'dphilhower-studio' ),
					'story'   => __( 'The seal in the center so a glass still frames the mark.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'black-olive-print-loyalty.png',
					'alt'     => __( 'Black Olive loyalty card', 'dphilhower-studio' ),
					'heading' => __( 'Loyalty card', 'dphilhower-studio' ),
					'story'   => __( 'Ten visits, one meze. Oval punches so every return restates the seal.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'black-olive-print-poster.png',
					'alt'     => __( 'Black Olive dining-room poster', 'dphilhower-studio' ),
					'heading' => __( 'Dining-room poster', 'dphilhower-studio' ),
					'story'   => __( 'The line is the only copy besides the seal. Cream sheet, olive ink, one Aegean rule.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'black-olive-print-matches.png',
					'alt'     => __( 'Black Olive napkin band and matchbook', 'dphilhower-studio' ),
					'heading' => __( 'Napkin band and matchbook', 'dphilhower-studio' ),
					'story'   => __( 'Olive band around cream linen. The matchbook is a pocket version of the poster line.', 'dphilhower-studio' ),
				),
			),
		),
		'mizu' => array(
			'label'  => __( 'Print system', 'dphilhower-studio' ),
			'title'  => __( 'The seal, then the steam', 'dphilhower-studio' ),
			'intro'  => __( 'Official Mizu badge on black. White vinyl on the dusk window. Cream menu. Chili oil, takeaway, cards, coasters, loyalty, poster, and matchbook carry the same indigo and vermillion.', 'dphilhower-studio' ),
			'pieces' => array(
				array(
					'file'    => 'mizu-print-seal.png',
					'alt'     => __( 'Mizu seal', 'dphilhower-studio' ),
					'heading' => __( 'Seal', 'dphilhower-studio' ),
					'story'   => __( 'The official lockup. White MIZU, indigo plate, vermillion ring. The food stays inside.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'mizu-print-window.png',
					'alt'     => __( 'Mizu window', 'dphilhower-studio' ),
					'heading' => __( 'Window', 'dphilhower-studio' ),
					'story'   => __( 'Seal on glass, cream hours, hanging wordmark. The sidewalk should know the room before the door.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'mizu-print-menu.png',
					'alt'     => __( 'Mizu menu', 'dphilhower-studio' ),
					'heading' => __( 'Menu', 'dphilhower-studio' ),
					'story'   => __( 'Cream stock, indigo headings, thin vermillion rules. No food photos.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'mizu-print-pack.png',
					'alt'     => __( 'Mizu oil and box', 'dphilhower-studio' ),
					'heading' => __( 'Oil and box', 'dphilhower-studio' ),
					'story'   => __( 'Same seal on glass and kraft. Chili oil 200 mL, ramen takeaway, lot MZ-260922.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'mizu-print-cards.png',
					'alt'     => __( 'Mizu business cards', 'dphilhower-studio' ),
					'heading' => __( 'Business cards', 'dphilhower-studio' ),
					'story'   => __( 'Indigo field is the night, white MIZU is the window stamp in a pocket.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'mizu-print-coasters.png',
					'alt'     => __( 'Mizu coasters', 'dphilhower-studio' ),
					'heading' => __( 'Coasters', 'dphilhower-studio' ),
					'story'   => __( 'The seal in the center so a glass still frames the mark.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'mizu-print-loyalty.png',
					'alt'     => __( 'Mizu loyalty card', 'dphilhower-studio' ),
					'heading' => __( 'Loyalty card', 'dphilhower-studio' ),
					'story'   => __( 'Ten visits, one bowl. Oval punches so every return restates the seal.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'mizu-print-poster.png',
					'alt'     => __( 'Mizu dining-room poster', 'dphilhower-studio' ),
					'heading' => __( 'Dining-room poster', 'dphilhower-studio' ),
					'story'   => __( 'The line is the only copy besides the seal. Cream sheet, indigo ink, one vermillion rule.', 'dphilhower-studio' ),
				),
				array(
					'file'    => 'mizu-print-matches.png',
					'alt'     => __( 'Mizu napkin band and matchbook', 'dphilhower-studio' ),
					'heading' => __( 'Napkin band and matchbook', 'dphilhower-studio' ),
					'story'   => __( 'Indigo band around cream linen. The matchbook is a pocket version of the poster line.', 'dphilhower-studio' ),
				),
			),
		),
