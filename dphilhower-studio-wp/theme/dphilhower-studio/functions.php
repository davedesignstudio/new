...
function dps_assets() {
	wp_enqueue_style(
		'dps-fonts',
		'https://fonts.googleapis.com/css2?family=Inter:ital,wght@0,400;0,500;0,600;1,400&family=Space+Grotesk:wght@500;600;700&display=swap',
		array(),
		null
	);
...
function dps_maybe_upgrade_images() {
	...
	if ( get_option( 'dps_images_version' ) === 'brands-print-3' ) {
		return;
	}
