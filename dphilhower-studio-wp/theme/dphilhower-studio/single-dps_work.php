...
<main id="main">
	...
	while ( have_posts() ) :
		...
		?>
		<p class="section" style="padding-top:0"><a class="btn btn-outline" href="<?php echo esc_url( get_post_type_archive_link( 'dps_work' ) ); ?>"><?php esc_html_e( 'All work', 'dphilhower-studio' ); ?></a></p>
	<?php endwhile; ?>
